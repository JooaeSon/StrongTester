...
--시퀀스의 증가값 변동 (원상복구)
ALTER SEQUENCE VIDEO_SEQ INCREMENT BY 1;
...
VALUES ('1', '20162625', 'A033212', 'SSUIT', '20');

INSERT INTO STUDENTANSWER (TEST_NUM, STUDENT_CODE, TEST_CODE, USER_ID, STUDENT_SCORE) 
VALUES ('2', '20162625', 'A033212', 'SSUIT', '17');

INSERT INTO STUDENTANSWER (TEST_NUM, STUDENT_CODE, TEST_CODE, USER_ID, STUDENT_SCORE) 
VALUES ('3', '20162625', 'A033212', 'SSUIT', '15');
...
UPDATE STUDENTANSWER SET STUDENT_ANSWER= ''
WHERE STUDENT_CODE ='20162625' AND TEST_NUM='1';

SELECT * FROM STUDENTANSWER s ;
--웹캠 정보 세팅
...
VALUES(VIDEO_SEQ.NEXTVAL, '20162579', 'A033212', 'SSUIT', 'SSUITA033212201624232020101217-07-05.mp4');
